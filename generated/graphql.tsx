...
export type PublishProductReviewMutation = {
	__typename?: 'Mutation';
	publishReview?: { __typename?: 'Review'; id: string } | null;
};
...
export type GetProductDetailsBySlugQuery = {
	...
	product?: {
		...
		slug: string;
		images: Array<{ __typename?: 'Asset'; url: string }>;
		reviews: Array<{ __typename?: 'Review'; id: string; name: string; content: string; createdAt: any }>;
	} | null;
};

export type GetProductsListSlugsQueryVariables = Exact<{ [key: string]: never }>;

export type GetProductsListSlugsQuery = {
	__typename?: 'Query';
...
`;
export type PublishProductReviewMutationFn = Apollo.MutationFunction<
	PublishProductReviewMutation,
	PublishProductReviewMutationVariables
>;
 ...
 * });
 */
export function usePublishProductReviewMutation(
	baseOptions?: Apollo.MutationHookOptions<PublishProductReviewMutation, PublishProductReviewMutationVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useMutation<PublishProductReviewMutation, PublishProductReviewMutationVariables>(
...
export type PublishProductReviewMutationOptions = Apollo.BaseMutationOptions<
	PublishProductReviewMutation,
	PublishProductReviewMutationVariables
>;
 ...
 * });
 */
export function useGetProductsListSlugsQuery(
	baseOptions?: Apollo.QueryHookOptions<GetProductsListSlugsQuery, GetProductsListSlugsQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<GetProductsListSlugsQuery, GetProductsListSlugsQueryVariables>(
		GetProductsListSlugsDocument,
		options,
	);
}
export function useGetProductsListSlugsLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<GetProductsListSlugsQuery, GetProductsListSlugsQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<GetProductsListSlugsQuery, GetProductsListSlugsQueryVariables>(
		GetProductsListSlugsDocument,
		options,
	);
}
...
export type GetProductsListSlugsQueryResult = Apollo.QueryResult<
	GetProductsListSlugsQuery,
	GetProductsListSlugsQueryVariables
>;
