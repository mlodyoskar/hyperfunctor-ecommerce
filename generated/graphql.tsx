...
export type UpdateOrderStatusMutation = { __typename?: 'Mutation', updateOrder?: { __typename?: 'Order', id: string } | null };

export type GetProductsListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductsListQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, name: string, price: number, slug: string, description: string, images: Array<{ __typename?: 'Asset', url: string }> }> };
...
export type GetProductBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, slug: string, name: string, description: string, price: number, images: Array<{ __typename?: 'Asset', url: string }> } | null };
...
export type GetProductDetailsBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, name: string, description: string, price: number, slug: string, images: Array<{ __typename?: 'Asset', url: string }>, reviews: Array<{ __typename?: 'Review', id: string, name: string, content: string, createdAt: any }> } | null };

export type GetProductsListSlugsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductsListSlugsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', slug: string }> };
...
export const CreateOrderDocument = gql`
    mutation CreateOrder($orderStatus: OrderStatus!, $email: String!, $stripeCheckoutId: String!, $total: Int!, $create: [OrderItemCreateInput!]) {
  createOrder(
    data: {orderStatus: $orderStatus, email: $email, total: $total, stripeCheckoutId: $stripeCheckoutId, orderItems: {create: $create}}
  ) {
    id
    orderItems {
      id
...
export const GetProductsListSlugsDocument = gql`
...
/**
 * __useGetProductsListSlugsQuery__
 *
 * To run a query within a React component, call `useGetProductsListSlugsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductsListSlugsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProductsListSlugsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetProductsListSlugsQuery(baseOptions?: Apollo.QueryHookOptions<GetProductsListSlugsQuery, GetProductsListSlugsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductsListSlugsQuery, GetProductsListSlugsQueryVariables>(GetProductsListSlugsDocument, options);
      }
export function useGetProductsListSlugsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductsListSlugsQuery, GetProductsListSlugsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductsListSlugsQuery, GetProductsListSlugsQueryVariables>(GetProductsListSlugsDocument, options);
        }
export type GetProductsListSlugsQueryHookResult = ReturnType<typeof useGetProductsListSlugsQuery>;
export type GetProductsListSlugsLazyQueryHookResult = ReturnType<typeof useGetProductsListSlugsLazyQuery>;
export type GetProductsListSlugsQueryResult = Apollo.QueryResult<GetProductsListSlugsQuery, GetProductsListSlugsQueryVariables>;
